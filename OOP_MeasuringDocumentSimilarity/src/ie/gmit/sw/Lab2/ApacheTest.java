...
public class ApacheTest   {
	 ...
	 * Does the calculation by identifying the union (characters in at least one of
	 * the two sets) of the two sets and intersection (characters which are present
	 * in set one which are present in set two)
	 *
	 * @param left
	 *            first character sequence
	 * @param right
